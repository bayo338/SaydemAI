...
const services = [
  {
    ...
    description:
      'Kickstart your final year project report with a detailed draft tailored to your topic and school’s format—instantly.',
  },
  {
    icon: <FaEdit className="text-green-600 w-8 h-8" />,
    title: 'Smart Editing with Prompts',
    description:
      'Update, expand, or refine any section of your report using simple prompts—no need to start over.',
  },
  {
    icon: <FaBook className="text-green-600 w-8 h-8" />,
    title: 'Verified References & Original Content',
    description:
      'Get citations from real research papers, journals, and articles. All content is plagiarism‑free and AI detection‑friendly.',
  },
  {
    icon: <FaSlideshare className="text-green-600 w-8 h-8" />,
    title: 'Presentation Slides',
    description:
      'Automatically generate polished slide decks that summarize your report’s key points—ready to present.',
  },
];
    ...
    <section id="services" className="relative bg-white overflow-hidden py-24 dark:bg-gray-900 text-gray-900 dark:text-white rounded-lg shadow-md p-4 transition-all ">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 text-center max-w-2xl mx-auto">
          Everything you need to take your final year project from idea to presentation.
        </p>
